...
* @param {Object} siphonObj - Provides Siphon Object for access to its values
*/
const createWorker = (statMsg, siphonObj) => {
...
*/
const checkJobs = (workers, statMsg, siphonObj) => {
...
* @param {Object} siphonObj - Provides Siphon Object for later access to its values
*/
const assignJobs = (urlArray, workers, statMsg, siphonObj) => {
  let num = 0;
...
*/
const reviver = (key, value) => key === 'notifyFunction' ? new Function('return ' + value)() : value;
