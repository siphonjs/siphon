...
module.exports = { cheerio, get, post, setHeaders, find, retries, store, execute, setProxies, setWorkers, giveWorker, run, selenium, setInterval, setAuth, crawler, notify };
